...
public interface DetalleVentaRepository extends JpaRepository<DetalleVenta, Long> {
     ...
     * @param pageable Un objeto Pageable para limitar los resultados.
     * @return Una lista de arrays de objetos, donde cada array contiene [Producto, cantidadTotalVendida].
     */
    @Query("SELECT dv.producto, SUM(dv.cantidad) FROM DetalleVenta dv GROUP BY dv.producto ORDER BY SUM(dv.cantidad) DESC")
